const config = {
  ...
  contacts: {
    address: 'Khasra no. 328, Near Ashok Leyland Workshop, Alwar Bypass Road, Bhiwadi, Alwar (Rajasthan) 301019',
    phones: [
  ...
  partners: [
    ...
    { name: 'Mapei', logo: '/partners/mapei.png' },
    { name: 'Fosroc', logo: '/partners/fosroc.png' },
    { name: 'Cipy', logo: '/partners/cipy.png' },
    { name: 'Master Builders', logo: '/partners/mbs.png' },
    { name: 'MC-Bauchemie', logo: '/partners/mc.png' },
    { name: 'BASF', logo: '/partners/basf.png' },
    { name: 'Bekaert', logo: '/partners/bekaert.png' },
  ],
  services: [
